      ...
      setCategories([
        {
          ...
          name: 'Breads',
          slug: 'breads',
          description: 'Artisan breads, sourdough, whole grain, and specialty loaves',
          productCount: 150,
          image: '/placeholder-breads-category.jpg',
          icon: <Wheat size={32} />,
          color: '#D2691E',
          trending: true,
          subcategories: ['Sourdough', 'Whole Grain', 'White Bread', 'Specialty Breads', 'Rolls']
        },
        {
          id: 2,
          name: 'Pastries',
          slug: 'pastries',
          description: 'Fresh croissants, danishes, turnovers, and flaky pastries',
          productCount: 200,
          image: '/placeholder-pastries-category.jpg',
          icon: <Croissant size={32} />,
          color: '#DEB887',
          trending: true,
          subcategories: ['Croissants', 'Danishes', 'Turnovers', 'Puff Pastries', 'Éclairs']
        },
        {
          id: 3,
          name: 'Cakes',
          ...
          productCount: 80,
          image: '/placeholder-cakes-category.jpg',
          icon: <Cake size={32} />,
          color: '#FF69B4',
          trending: false,
        ...
        },
        {
          ...
          productCount: 120,
          image: '/placeholder-cookies-category.jpg',
          icon: <Cookie size={32} />,
          color: '#CD853F',
          trending: false,
        ...
        },
        {
          ...
          productCount: 90,
          image: '/placeholder-muffins-category.jpg',
          icon: <Cherry size={32} />,
          color: '#FFB6C1',
          trending: false,
        ...
        },
        {
          ...
          productCount: 60,
          image: '/placeholder-donuts-category.jpg',
          icon: <Donut size={32} />,
          color: '#FF6347',
          trending: true,
        ...
        },
        {
          ...
          productCount: 45,
          image: '/placeholder-bagels-category.jpg',
          icon: <Circle size={32} />,
          color: '#DAA520',
          trending: false,
        ...
        },
        {
          ...
          productCount: 70,
          image: '/placeholder-specialty-category.jpg',
